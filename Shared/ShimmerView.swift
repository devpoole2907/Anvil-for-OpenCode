...
private struct ShimmerOverlay: View {
    ...
    var body: some View {
        ...
        // NOTE: GeometryReader retained because the shimmer specifically needs the parent's
        // width to compute its sweep offset; containerRelativeFrame doesn't help in this case.
    }
}
