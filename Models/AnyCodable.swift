...
/// Tool inputs/outputs from opencode are unstructured JSON; this lets us round-trip
/// them without committing to a strict schema. Use `decoded(_:)` to extract a known shape.
struct AnyCodable: Codable, Hashable, @unchecked Sendable {
    ...
    /// Re-encode to JSON then decode as `T`. Useful for view code that wants a typed shape.
